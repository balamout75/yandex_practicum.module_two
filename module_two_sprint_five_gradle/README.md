...
- В работе столкнулся с проблемой циклических зависимостей. Поэтому пришлось отстроить ветки связей сервисов: большинство запросов поступают в репозитории по цепочке UserService -> ItemService -> (CartService|OrderService) -> (CartItenService|OrderItenService).      
---
